public class DataType{
	public static void main(String[] args){
		...
		double cbnBalance = 848930939893893893.744463;
		System.out.printf("The CBN balnce is %,.2f%n",cbnBalance);
		
		char symbol = '@';
		System.out.printf("Your email address is ivanadaniel33%cgmail.com%n",symbol);
